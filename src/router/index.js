...
const routes = [
  ...
  },
  {
    ...
    component: () =>
      import("../pages/workspace/quality/QualityFeedbackPage.vue"),
    meta: { title: "质量快反" },
  },
  {
    ...
    component: () =>
      import("../pages/workspace/qiandiao/QiandiaoFeedbackPage.vue"),
    meta: { title: "钳调反馈" },
  },
  {
    ...
    name: "OtherWorktime",
    component: () =>
      import("../pages/workspace/otherWorktime/OtherWorktimePage.vue"),
    meta: { title: "其他工时" },
  },
];
